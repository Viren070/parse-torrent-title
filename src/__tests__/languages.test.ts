...
describe('Language Detection Tests', () => {
  ...
  const testCases: [string, string[] | undefined][] = [
    ...
    ["EMPIRE STATE 2013 DVDRip TRNC English and Española Latin", ["en", "es-419"]],
    ...
    ["Abuela (2015) 1080p BluRay x264 AC3 Dual Latino-Inglés", ["dual audio", "en", "es-419"]],
    ...
    ["Star.Wars.Skeleton.Crew.Sezon01.PLDUB.480p.DSNP.WEB-DL.H264.DDP5.1-K83", ["pl"]],
    ["Bukmacher / Bookie [E02E07] [MULTi] [1080p] [AMZN] [WEB-DL] [H264] [DDP5.1.Atmos-K83] [Lektor PL]", ["multi audio", "pl"]],
    ["Gra 1968 [REKONSTRUKCJA] [1080p.WEB-DL.H264.AC3-FT] [Film Polski]", ["pl"]],
    ["Evil.Dead.Rise.2023.PLSUB.720p.MA.WEB-DL.H264.E-AC3-CMRG", ["pl"]],
    ["Wallace i Gromit: Zemsta pingwina / Wallace & Gromit: Vengeance Most Fowl (2024) [480] [WEB-DL] [XviD] [DD5.1-K83] [Dubbing PL]", ["pl"]],
    ["Strażniczka smoków / Dragonkeeper (2024) [1080p] [H264] [Napisy PL]", ["pl"]],
    ["Carros 2 Dublado - Portugues BR (2011)", ["pt"]],
    ["A.Simples.Plan.1998.720p.BDRIP.X264.dublado.portugues.BR.gmenezes", ["pt"]],
    ...
    ["Mommie Dearest [1981 PAL DVD][En.De.Fr.It.Es Multisubs[18]", ["multi subs", "en", "fr", "es", "it", "de"]],
    ...
    ["[NC-Raws] 叫我對大哥 (WEB版) / Ore, Tsushima - 10 [Baha][WEB-DL][1080p][AVC AAC][CHT][MP4]", ["zh"]],
    ...
    ["Joker.2019.MULTi.Bluray.1080p.Atmos.7.1.En.Fr.Sp.Pt-DDR[EtHD]", ["multi audio", "en", "fr", "es", "pt"]],
    ...
    ["[IceBlue] Naruto (Season 01) - [Multi-Dub][Multi-Sub][Dublado][HEVC 10Bits] 800p BD", ["multi subs", "multi audio", "pt"]],
    ...
    ["Inglês,Português,Italiano,Francês,Polonês,Russo,Norueguês,Dinamarquês,Alemão,Espanhol,Chinês,Japonês,Coreano,Persa,Hebraico,Sueco,Árabe,Holandês,Tâmil,Tailandês", ["en", "ja", "ko", "zh", "fr", "es", "pt", "it", "de", "ru", "ta", "pl", "nl", "da", "sv", "no", "th", "he", "fa"]],
    ...
    ["[Hakata Ramen] Hoshiai No Sora (Stars Align) 01 [1080p][HEVC][x265][10bit][Dual-Subs] HR-DR", undefined],
    ...
    ["Russian.Doll.S02E02.2160p.NF.WEB-DL.DDP5.1.HDR.DV.HEVC-PEXA.mkv", undefined],
    ["The.Spanish.Prisoner.1997.1080p.BluRay.x265-RARBG", undefined],
    ["Japanese.Story.2003.1080p.WEBRip.x264-RARBG", undefined],
    ["[ Torrent9.cz ] The.InBetween.S01E10.FiNAL.HDTV.XviD-EXTREME.avi", undefined],
    ...
    ["Godzilla.x.Kong.The.New.Empire.2024.2160p.BluRay.REMUX.DV.P7.HDR.ENG.LATINO.GER.ITA.FRE.HINDI.CHINESE.TrueHD.Atmos.7.1.H265-BEN.THE.MEN", ["en", "zh", "fr", "es-419", "it", "de", "hi"]],
    ["Sampurna.2023.Bengali.S02.1080p.AMZN.WEB-DL.DD+2.0.H.265-TheBiscuitMan", ["bn"]],
    ["Kingdom.of.the.Planet.of.the.Apes.2024.HDRIP.1080P.[xDark [SaveHD] Latin + English + Hindi.mp4", ["en", "es-419", "hi"]],
    ["The Karate Kid Part III 1989 1080p DUAL TİVİBU WEB-DL x264 AAC - HdT", ["dual audio", "tr"]],
    ["The French Connection 1971 Remastered BluRay 1080p REMUX AVC DTS-HD MA 5 1-LEGi0N", undefined],
    ["The.Gorge.2025.PLSUB.1080p.ATVP.WEB-DL.DDP5.1.Atmos.H.264-APEX.mkv", ["pl"]],

    // Go tests
    ["[Ex-torrenty.org]iCarly.S04.PLDUB.1080p.AMZN.WEB-DL.DDP2.0.H264-Ralf", ["pl"]],
    ["BLACK PANTHER - Wakanda Forever (2022) 10bit.m1080p.BRRip.H265.MKV.AC3-5.1 DUBPL-ENG-NapisyPL [StarLord]", ["en", "pl"]],
    ["Shrek_Forever_After_(2010)__3D_HSBS_(DubbingPL).mkv", ["pl"]],
    ["Star Trek [2009] [RmvB] [LekPL].rmvb", ["pl"]],
    ["[FileTracker] Breaking Bad S02E08 [lektorPL][480p.WEB-DL.XviD][avi]", ["pl"]],
    ["Game of Thrones - Sezon 4 Odcinek 10 [480p.720p.WEB-DL.H264-NitroTeam] [Lektor PL].mkv", ["pl"]],
    ["Everest.2015.FRENCH.VFQ.BDRiP.x264-CNF30", ["fr"]],
    ["Showdown.In.Little.Tokyo.1991.MULTI.VFQ.VFF.DTSHD-MASTER.1080p.BluRay.x264-ZombiE", ["multi audio", "fr"]],
    ["Nocturnal Animals (2016) MULTi VFQ [1080p] BluRay x264-PopHD", ["multi audio", "fr"]],
