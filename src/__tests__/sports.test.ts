...
describe('parseTorrentTitle - sports', () => {
  ...
  test('UFC 219 Cyborg vs Holm', () => {
    const result = parseTorrentTitle('UFC.219.PPV.Cyborg.vs.Holm.720p.HDTV.x264-KYR[rartv]');
  ...
  test('UFC 218 Holloway vs Aldo 2', () => {
    const result = parseTorrentTitle('UFC.218.PPV.Holloway.vs.Aldo.2.HDTV.x264-Ebi[TGx]');
