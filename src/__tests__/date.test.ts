...
describe('Date Detection Tests', () => {
  describe('Valid Dates', () => {
    ...
    test('Stephen Colbert 25/10/2019', () => {
      const result = parseTorrentTitle(
        'Stephen Colbert 25/10/2019 Eddie Murphy 480p x264-mSD [eztv]'
      );
      expect(result.date).toBe('2019-10-25');
    });
    ...
    test('WWE RAW 1st Dec 2019', () => {
      const result = parseTorrentTitle(
        'WWE RAW 1st Dec 2019 WEBRip h264-TJ [TJET]'
      );
    ...
    test('WWE RAW 2nd Dec 2019', () => {
      const result = parseTorrentTitle(
        'WWE RAW 2nd Dec 2019 WEBRip h264-TJ [TJET]'
      );
    ...
    test('WWE RAW 3rd Dec 2019', () => {
      const result = parseTorrentTitle(
        'WWE RAW 3rd Dec 2019 WEBRip h264-TJ [TJET]'
      );
    ...
    test('AEW DARK 4th November 2020', () => {
      const result = parseTorrentTitle(
        'AEW DARK 4th November 2020 WEBRip h264-TJ'
      );
    ...
    test('AEW DARK 4th October 2020', () => {
      const result = parseTorrentTitle(
        'AEW DARK 4th October 2020 WEBRip h264-TJ'
      );
    ...
    test('AEW DARK 4th September 2020', () => {
      const result = parseTorrentTitle(
        'AEW DARK 4th September 2020 WEBRip h264-TJ'
      );
    ...
    test('WWE Main Event 4th July 2020', () => {
      const result = parseTorrentTitle(
        'WWE Main Event 4th July 2020 WEBRip h264-TJ'
      );
    ...
    test('WWE Main Event 4th June 2020', () => {
      const result = parseTorrentTitle(
        'WWE Main Event 4th June 2020 WEBRip h264-TJ'
      );
    ...
    test('WWE Main Event 4th May 2020', () => {
      const result = parseTorrentTitle(
        'WWE Main Event 4th May 2020 WEBRip h264-TJ'
      );
    ...
    test('WWE Main Event 4th April 2020', () => {
      const result = parseTorrentTitle(
        'WWE Main Event 4th April 2020 WEBRip h264-TJ'
      );
    ...
    test('WWE Main Event 3rd March 2020', () => {
      const result = parseTorrentTitle(
        'WWE Main Event 3rd March 2020 WEBRip h264-TJ'
      );
    ...
    test('WWE Main Event 2nd February 2020', () => {
      const result = parseTorrentTitle(
        'WWE Main Event 2nd February 2020 WEBRip h264-TJ'
      );
    ...
    test('WWE Main Event 1st January 2020', () => {
      const result = parseTorrentTitle(
        'WWE Main Event 1st January 2020 WEBRip h264-TJ'
      );
  ...
  describe('Should Not Detect Date', () => {
    ...
    test('not detect date from movie title v2', () => {
      const result = parseTorrentTitle(
        '11-11-11.2011.1080p.BluRay.x264.DTS-FGT'
      );
      expect(result.date).toBeUndefined();
    });
  });
